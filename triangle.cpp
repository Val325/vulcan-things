...
class Model {
    ...
    public:
        ...
        void render(VkDevice dev, VkPhysicalDevice phyDev, VkCommandPool comPool, VkQueue graphQue) {
            device = dev;
            physicalDevice = phyDev;
            commandPool = comPool;
            graphicsQueue = graphQue;
    ...
    void loadModel() {
        ...
        std::string warn, err;
            ...
            if (!tinyobj::LoadObj(&attrib, &shapes, &materials, &warn, &err, models_path.c_str())) {
...
public:
    void run() {
        ...
        cat.addDataPaths(MODEL_PATH, TEXTURE_PATH);
        building.addDataPaths(MODEL_PATH2, TEXTURE_PATH2);
        cat.render(device, physicalDevice, commandPool, graphicsQueue);
        building.render(device, physicalDevice, commandPool, graphicsQueue);
