...
private:
    ...
    void createTextureImage() {
        ...
        for (auto& texture : texture_path) { 
            pixels = stbi_load(texture.c_str(), &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
        }
